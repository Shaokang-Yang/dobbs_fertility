...
def clean_dataframe(dat:pd.DataFrame, outcome_type="births", cat_name="total", 
                    ...
                    csv_filename='/Users/shaokangyang/Library/CloudStorage/GoogleDrive-sky.ang510@gmail.com/My Drive/Code/fertility_results/2024/dat_quarterly.csv'):
    """
...
if __name__ == '__main__':
    ...
    import gzip
    import sys
    sys.argv = ['script.py', '/Users/shaokangyang/Library/CloudStorage/GoogleDrive-sky.ang510@gmail.com/My Drive/Code/fertility_results/2024/df_through_june.csv', '--save-dict', '--group', 'race']
    ...
    directory_name = '/Users/shaokangyang/Library/CloudStorage/GoogleDrive-sky.ang510@gmail.com/My Drive/Code/fertility_results/2024/model_data/' + args.filename.split('/')[-1].split('.')[0]
